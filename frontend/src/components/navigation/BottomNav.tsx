...
export const BottomNav = () => {
    const navItems = [
        ...
        { label: 'Market', icon: Map, path: '/market' },
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-border flex items-center justify-between px-2 z-50">
                ...
                return (
                    <NavLink
                        ...
                        className={({ isActive }) => clsx(
                            ...
                            isActive ? 'text-brand' : 'text-textSecondary'
                        )}
                    >
