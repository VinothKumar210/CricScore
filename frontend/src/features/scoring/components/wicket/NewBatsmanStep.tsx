        ...
        <div className="flex flex-col h-full">
            <div className="flex items-center mb-4">
                <button
                    ...
                    className="text-sm text-textSecondary hover:text-textPrimary px-2 py-1 -ml-2 disabled:opacity-50"
                >
                    ← Back
                </button>
                ...
                <div className="flex flex-col gap-2">
                    {players.map((player) => (
                        <button
                            ...
                            disabled={isSubmitting}
                            className="flex items-center p-3 rounded-lg hover:bg-surface border border-transparent hover:border-border transition-colors text-left disabled:opacity-50"
                        >
