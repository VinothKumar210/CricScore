...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transform-gpu active:scale-95",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input/30 bg-gradient-to-r from-background/50 to-background/30 backdrop-blur-sm hover:bg-background/80 hover:border-primary/50 shadow-sm hover:shadow-md",
        secondary:
