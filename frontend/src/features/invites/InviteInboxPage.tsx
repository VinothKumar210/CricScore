...
export const InviteInboxPage: React.FC = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-foreground dark:text-white mb-2">My Invites</h1>
            ...
            {isLoading && displayList.length === 0 ? (
                ...
                <div className="space-y-4 relative">
                    {isLoading && (
                        <div className="absolute inset-0 bg-card/50 dark:bg-card-950/50 backdrop-blur-sm z-10 flex items-center justify-center rounded-xl">
                            <RefreshCw className="h-8 w-8 text-primary-500 animate-spin" />
                        </div>
                    )}
