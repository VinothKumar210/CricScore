...
const getIconForType = (type: Notification['type']) => {
    switch (type) {
        ...
        case 'TOURNAMENT_ELIMINATED':
            return <TrophyIcon className="h-6 w-6 text-brand-500" />;
    ...
    return (
        <div
            className={`${t.visible ? 'animate-enter' : 'animate-leave'
                } max-w-sm w-full bg-white dark:bg-card-900 shadow-xl rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5 dark:ring-white dark:ring-opacity-10`}
        >
